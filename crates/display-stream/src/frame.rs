...
// These mirror the callback's geometry arguments and exact pixel groups.
...
// pixman_format_code(32, PIXMAN_TYPE_ARGB/ABGR, a, 8, 8, 8).
const PIXMAN_X8R8G8B8: u32 = 0x2002_0888;
const PIXMAN_A8R8G8B8: u32 = 0x2002_8888;
const PIXMAN_X8B8G8R8: u32 = 0x2003_0888;
const PIXMAN_A8B8G8R8: u32 = 0x2003_8888;
...
impl PixelFormat {
    ...
    pub fn from_pixman(value: u32) -> Option<Self> {
        ...
        match value {
            PIXMAN_X8R8G8B8 => Some(Self::X8R8G8B8),
            PIXMAN_A8R8G8B8 => Some(Self::A8R8G8B8),
            PIXMAN_X8B8G8R8 => Some(Self::X8B8G8R8),
            PIXMAN_A8B8G8R8 => Some(Self::A8B8G8R8),
            _ => None,
        }
    }
}
...
pub fn pixman_from_fourcc(fourcc: u32) -> Option<u32> {
    match fourcc {
        ...
        0x3432_5258 => Some(PIXMAN_X8R8G8B8),
        0x3432_5241 => Some(PIXMAN_A8R8G8B8),
        // DRM_FORMAT_XBGR8888 / ABGR8888, little-endian RGBA bytes.
        0x3432_4258 => Some(PIXMAN_X8B8G8R8),
        0x3432_4241 => Some(PIXMAN_A8B8G8R8),
        _ => None,
    }
}
...
mod tests {
    ...
    const BGRA: u32 = PIXMAN_A8R8G8B8;

    #[test]
    fn pixman_and_drm_formats_match_qemu_display_formats() {
        assert_eq!(PIXMAN_X8R8G8B8, 0x2002_0888);
        assert_eq!(PIXMAN_A8R8G8B8, 0x2002_8888);
        assert_eq!(PIXMAN_X8B8G8R8, 0x2003_0888);
        assert_eq!(PIXMAN_A8B8G8R8, 0x2003_8888);
        for (pixman, pixel_format, fourcc) in [
            (PIXMAN_X8R8G8B8, PixelFormat::X8R8G8B8, 0x3432_5258),
            (PIXMAN_A8R8G8B8, PixelFormat::A8R8G8B8, 0x3432_5241),
            (PIXMAN_X8B8G8R8, PixelFormat::X8B8G8R8, 0x3432_4258),
            (PIXMAN_A8B8G8R8, PixelFormat::A8B8G8R8, 0x3432_4241),
        ] {
            assert_eq!(PixelFormat::from_pixman(pixman), Some(pixel_format));
            assert_eq!(pixman_from_fourcc(fourcc), Some(pixman));
        }
    }
